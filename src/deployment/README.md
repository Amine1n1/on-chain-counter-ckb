...
offckb deploy --network devnet --target <contract-binary-path> --output /Users/aminegaddah/Documents/OffCKB_CKB_Contracts/counter/deployment
```
...
```bash
# Deploy to testnet
offckb deploy --network testnet --target <contract-binary-path> --output /Users/aminegaddah/Documents/OffCKB_CKB_Contracts/counter/deployment
```
